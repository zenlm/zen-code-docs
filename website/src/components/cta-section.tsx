    ...
    <section className="py-24 bg-gradient-to-br from-background via-muted/10 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <Badge variant="outline" className="px-4 py-2 mb-6 border-primary/30 bg-primary/10 hover:bg-primary/20 transition-smooth">
          ...
          <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
            Join thousands of developers who are already using Qwen Code to understand, edit, and automate their codebases with AI-powered assistance.
          </p>
          ...
          {/* Quick Start Card */}
          <div className="bg-card/50 backdrop-blur border border-primary/20 rounded-3xl p-8 max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center">
                <Code2 className="w-5 h-5 text-primary" />
              </div>
              <h3 className="text-lg font-semibold">Get Started in Seconds</h3>
            </div>
            
            <div className="bg-background/80 border border-border rounded-xl p-4 font-mono text-sm mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              No configuration needed. Authenticate with your qwen.ai account and start coding immediately.
            </p>
          </div>
          ...
          <div className="flex justify-center gap-8 mt-12 text-sm text-muted-foreground">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-accent-blue mb-1">753</div>
              <div>Forks</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-accent-purple mb-1">2k+</div>
              <div>Daily Users</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-accent-orange mb-1">MIT</div>
              <div>License</div>
            </div>
          </div>
        </div>
